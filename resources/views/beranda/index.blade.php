...
<body>
  ...
  <main class="main" id="top">
    <nav class="navbar navbar-expand-lg fixed-top navbar-dark bg-info" data-navbar-on-scroll="data-navbar-on-scroll">
      <div class="container">
    ...
    <section>
      ...
      <div class="container">
        ...
        <div class="row gx-xl-7 mt-5">
          <div class="col-md-4 mb-6 mb-md-0 text-center text-md-start"><img class="w-50 w-md-100" src="{{ asset('boldo/assets/img/services/1.png') }}" alt="" />
          ...
          <div class="col-md-4 mb-6 mb-md-0 text-center text-md-start"><img class="w-50 w-md-100" src="{{ asset('boldo/assets/img/services/2.png') }}" alt="" />
            <h4 class="mt-3 my-1">Even cooler feature</h4>
            <p class="fs-1 mb-0">Learning curve network effects return on investment.</p><a class="text-dark fs-1 pb-2 fw-bold border-black border-bottom text-decoration-none" href="#">Explore page<i class="fa-solid fa-arrow-right ms-2"></i></a>
          </div>
          <div class="col-md-4 mb-6 mb-md-0 text-center text-md-start"><img class="w-50 w-md-100" src="{{ asset('boldo/assets/img/services/3.png') }}" alt="" />
            <h4 class="mt-3 my-1">Cool feature title</h4>
            <p class="fs-1 mb-0">Learning curve network effects return on investment.</p><a class="text-dark fs-1 pb-2 fw-bold border-black border-bottom text-decoration-none" href="#">Explore page<i class="fa-solid fa-arrow-right ms-2"></i></a>
          </div>
        </div>
        ...
        <div class="row mt-7 gx-xl-7">
          <div class="col-md-4 text-center text-md-start h-auto mb-5">
            <div class="d-flex justify-content-between flex-column h-100"><a href="#"><img class="w-75 w-md-100 rounded-2" src="{{ asset('boldo/assets/img/blog/1.png') }}" alt="" /></a>
              ...
              <div class="d-flex align-items-center justify-content-center justify-content-md-start gap-3"><img class="img-fluid" src="{{ asset('boldo/assets/img/blog/profile1.png') }}" alt="" /><a href="#">
                  <p class="mb-0 text-gray">Chandler Bing</p>
                </a></div>
            </div>
          </div>
          <div class="col-md-4 text-center text-md-start h-auto mb-5">
            <div class="d-flex justify-content-between flex-column h-100"><a href="#"><img class="w-75 w-md-100 rounded-2" src="{{ asset('boldo/assets/img/blog/2.png') }}" alt="" /></a>
              <div class="d-flex align-items-center justify-content-center justify-content-md-start gap-2 mt-3"><a href="#">
                  <p class="fw-bold mb-0 text-black">Category</p>
                </a>
                <p class="mb-0">November 22, 2021</p>
              ...
              <div class="d-flex align-items-center justify-content-center justify-content-md-start gap-3"><img class="img-fluid" src="{{ asset('boldo/assets/img/blog/profile2.png') }}" alt="" /><a href="#">
                  <p class="mb-0 text-gray">Rachel Green</p>
                </a></div>
            </div>
          </div>
          <div class="col-md-4 text-center text-md-start h-auto mb-5">
            <div class="d-flex justify-content-between flex-column h-100"><a href="#"><img class="w-75 w-md-100 rounded-2" src="{{ asset('boldo/assets/img/blog/3.png') }}" alt="" /></a>
              <div class="d-flex align-items-center justify-content-center justify-content-md-start gap-2 mt-3"><a href="#">
                  <p class="fw-bold mb-0 text-black">Category</p>
                </a>
                <p class="mb-0">November 22, 2021</p>
              ...
              <div class="d-flex align-items-center justify-content-center justify-content-md-start gap-3"><img class="img-fluid" src="{{ asset('boldo/assets/img/blog/profile3.png') }}" alt="" /><a href="#">
